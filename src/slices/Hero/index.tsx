...
import { TextSplitter } from "@/components/TextSpillter";
    ...
    >
      {isDesktop && (
        <View className="hero-scene pointer-events-none sticky top-0 z-50 -mt-[100vh] hidden h-screen w-screen md:block">
          <Scene />
          <Bubbles count={300} speed={2.4} repeat={true} />
        </View>
      )}
      <div className="grid">
        ...
        <div className="text-side-heading relative z-[80] grid h-screen items-center gap-4 md:grid-cols-2">
          <PrismicNextImage
          ...
          <div>
            ...
            <div className="text-side-body mt-4 max-w-2xl text-balance text-xl font-normal text-sky-950">
